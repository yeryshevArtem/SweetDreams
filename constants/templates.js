export const templates = {
    ...
    passwordValidationErrorMinLength: 'Password must be at least 7 characters long',
    passwordValidationErrorMaxLength: 'Password cannot contain more than 20 characters',
    passwordValidationErrorRequired: 'Password is required',
    emailInputFieldLabel: 'Email Address',
    passwordInputFieldLabel: 'Password',
    errorAlertDefaultBody: 'Someting went wrong. Please try to reload the application.',
